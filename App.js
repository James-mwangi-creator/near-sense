  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.header}>
        <Text style={styles.title}>Near Sense</Text>
        <Text style={styles.subtitle}>Detects nearby solid objects using phone sensors to prevent collisions</Text>
      </View>
      ...
      <View style={styles.content}>
        ...
        <TouchableOpacity style={[styles.button, {backgroundColor: '#FF6600'}]}>
